/**
 * Code taken from Dalamud.Bindings.ImGui ImU8String 
 * License: https://github.com/goatcorp/Dalamud/blob/d47a41b2953407335fcb136f4843ea8e096306fc/LICENSE
 * Ref point: https://github.com/goatcorp/Dalamud/blob/d47a41b2953407335fcb136f4843ea8e096306fc/imgui/Dalamud.Bindings.ImGui/ImU8String.cs
 */
...
public ref struct ImUtf8String
{
    ...
    public ImUtf8String(int literalLength, int formattedCount)
        : this(""u8)
    {
    ...
    public ImUtf8String(int literalLength, int formattedCount, IFormatProvider? formatProvider)
        : this(literalLength, formattedCount)
    {
        this.formatProvider = formatProvider;
    }

    public ImUtf8String(ReadOnlySpan<byte> text, bool ensureNullTermination = false)
        : this()
    {
    ...
    public ImUtf8String(ReadOnlyMemory<byte> text, bool ensureNullTermination = false)
        : this(text.Span, ensureNullTermination)
    {
    }

    public ImUtf8String(ReadOnlySpan<char> text)
        : this()
    {
        if (Unsafe.IsNullRef(in MemoryMarshal.GetReference(text)))
        {
    ...
    public ImUtf8String(ReadOnlyMemory<char> text)
        : this(text.Span)
    {
    }

    public ImUtf8String(string? text)
        : this(text.AsSpan())
    {
    }

    public unsafe ImUtf8String(byte* text)
        : this(MemoryMarshal.CreateReadOnlySpanFromNullTerminated(text))
    {
        this.state |= State.NullTerminated;
    }

    public unsafe ImUtf8String(char* text)
        : this(MemoryMarshal.CreateReadOnlySpanFromNullTerminated(text))
    {
    }

    public static ImUtf8String Empty => default;
    ...
    public static implicit operator ImUtf8String(ReadOnlySpan<byte> text) => new(text);
    public static implicit operator ImUtf8String(ReadOnlyMemory<byte> text) => new(text);
    public static implicit operator ImUtf8String(Span<byte> text) => new(text);
    public static implicit operator ImUtf8String(Memory<byte> text) => new(text);
    public static implicit operator ImUtf8String(byte[]? text) => new(text.AsSpan());
    public static implicit operator ImUtf8String(ReadOnlySpan<char> text) => new(text);
    public static implicit operator ImUtf8String(ReadOnlyMemory<char> text) => new(text);
    public static implicit operator ImUtf8String(Span<char> text) => new(text);
    public static implicit operator ImUtf8String(Memory<char> text) => new(text);
    public static implicit operator ImUtf8String(char[]? text) => new(text.AsSpan());
    public static implicit operator ImUtf8String(string? text) => new(text);
    public static unsafe implicit operator ImUtf8String(byte* text) => new(text);
    public static unsafe implicit operator ImUtf8String(char* text) => new(text);
    public static implicit operator ReadOnlySpan<byte>(ImUtf8String str) => str.Span;
    ...
    public ImUtf8String MoveOrDefault(ImUtf8String other)
    {
        if (!this.IsNull)
        {
            other.Recycle();
